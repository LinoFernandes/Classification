...
NTPspRF = []
BeginsTotal = []
Progression = ['Neutral']#['Slow', 'Fast']
for prog in Progression:
    Perf = open('/Users/Lino/PycharmProjects/Classification/NTPtoLastClass/' + 'NTPtoLastSMOTE_50_' + prog + '.txt','a')
    for window in Window:
        ...
        for ntp in range(2,6):
            ...
            if sys.platform == "darwin":
                path = '/Users/Lino/PycharmProjects/Preprocessing/NTPtoLast/' + prog + '/' + str(ntp) + 'TP'
