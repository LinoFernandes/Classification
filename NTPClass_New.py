...
for window in Window:
    for ntp in range(2, 7):
        ...
        for smote in [0, 50, 100, 150, 200]:
                    ...
                    if classifier == 0:
                        for kernel in range(0,2):
                            if kernel == 0:
                                ...
                                recall_NB_Last.append(evaluation.recall(1) * 100)
                                precision_NB_Last.append(evaluation.precision(1) * 100)
                            else:
                                ...
                                recall_NB_K.append(evaluation.recall(1) * 100)
                                precision_NB_K.append(evaluation.precision(1) * 100)


                                mapper.build_classifier(dataLastTrain)
                                evaluation = Evaluation(dataLastTrain)
                                evaluation.test_model(mapper, dataLastTest)
                                roc_NB_K_Last.append(evaluation.area_under_roc(1) * 100)
                                recall_NB_K_Last.append(evaluation.recall(1) * 100)
                                precision_NB_K_Last.append(evaluation.precision(1) * 100)
                    elif classifier == 1:
                        for degree in range(1,4):
                            ...
                            if degree == 1:
                                ...
                                recall_SVM_1.append(evaluation.recall(1) * 100)
                                precision_SVM_1.append(evaluation.precision(1) * 100)
                            elif degree == 2:
                                ...
                                recall_SVM_3.append(evaluation.recall(1) * 100)
                                precision_SVM_3.append(evaluation.precision(1) * 100)
                            ...
                            if degree == 1:
                                ...
                                recall_SVM_1_Last.append(evaluation.recall(1) * 100)
                                precision_SVM_1_Last.append(evaluation.precision(1) * 100)
                            elif degree == 2:
                                ...
                                recall_SVM_3_Last.append(evaluation.recall(1) * 100)
                                precision_SVM_3_Last.append(evaluation.precision(1) * 100)
                    else:
                        for numTrees in np.arange(5,25,5):
                            ...
                            if numTrees == 5:
                                ...
                                recall_RF_5.append(evaluation.recall(1) * 100)
                                precision_RF_5.append(evaluation.precision(1) * 100)
                            elif numTrees == 10:
                                roc_RF_10.append(evaluation.area_under_roc(1) * 100)
                                recall_RF_10.append(evaluation.recall(1) * 100)
                                precision_RF_10.append(evaluation.precision(1) * 100)
                            elif numTrees == 15:
                                roc_RF_15.append(evaluation.area_under_roc(1) * 100)
                                recall_RF_15.append(evaluation.recall(1) * 100)
                                precision_RF_15.append(evaluation.precision(1) * 100)
                            else:
                                roc_RF_20.append(evaluation.area_under_roc(1) * 100)
                                recall_RF_20.append(evaluation.recall(1) * 100)
                                precision_RF_20.append(evaluation.precision(1) * 100)
                            mapper.build_classifier(dataLastTrain)
                            evaluation = Evaluation(dataLastTrain)
                            evaluation.test_model(mapper, dataLastTest)
                            if numTrees == 5:
                                roc_RF_5_Last.append(evaluation.area_under_roc(1) * 100)
                                recall_RF_5_Last.append(evaluation.recall(1) * 100)
                                precision_RF_5_Last.append(evaluation.precision(1) * 100)
                            elif numTrees == 10:
                                roc_RF_10_Last.append(evaluation.area_under_roc(1) * 100)
                                recall_RF_10_Last.append(evaluation.recall(1) * 100)
                                precision_RF_10_Last.append(evaluation.precision(1) * 100)
                            elif numTrees == 15:
                                roc_RF_15_Last.append(evaluation.area_under_roc(1) * 100)
                                recall_RF_15_Last.append(evaluation.recall(1) * 100)
                                precision_RF_15_Last.append(evaluation.precision(1) * 100)
                            else:
                                roc_RF_20_Last.append(evaluation.area_under_roc(1) * 100)
                                recall_RF_20_Last.append(evaluation.recall(1) * 100)
                                precision_RF_20_Last.append(evaluation.precision(1) * 100)
            ...
            Scores.write(str(round(np.mean(roc_NB),2)) + ',' + str(round(np.mean(roc_NB_K),2)) + ',' + str(round(np.mean(roc_SVM_1),2)) + ',' + str(round(np.mean(roc_SVM_2),2)) + ',' + str(round(np.mean(roc_SVM_3),2)) + ',' + str(round(np.mean(roc_RF_5),2)) + ',' + str(round(np.mean(roc_RF_10),2)) + ',' + str(round(np.mean(roc_RF_15),2)) + ',' + str(round(np.mean(roc_RF_20),2)) + '\n')
            Scores.write(str(round(np.mean(roc_NB_Last),2)) + ',' + str(round(np.mean(roc_NB_K_Last),2)) + ',' + str(round(np.mean(roc_SVM_1_Last),2)) + ',' + str(round(np.mean(roc_SVM_2_Last),2)) + ',' + str(round(np.mean(roc_SVM_3_Last),2)) + ',' + str(round(np.mean(roc_RF_5_Last),2)) + ',' + str(round(np.mean(roc_RF_10_Last),2)) + ',' + str(round(np.mean(roc_RF_15_Last),2)) + ',' + str(round(np.mean(roc_RF_20_Last),2)) + '\n')
            ...
            # Perf.write(str(window) + ',' + str(ntp) + '_Last' + ',' + str(smote) + ',' + str(round(np.mean(roc_NB_Last),2)) + '%,' + str(round(np.mean(roc_NB_K_Last),2)) + '%,' + str(round(np.mean(roc_SVM_1_Last),2)) + '%,' + str(round(np.mean(roc_SVM_2_Last),2)) + '%,' + str(round(np.mean(roc_SVM_3_Last),2)) + '%,' + str(round(np.mean(roc_RF_5_Last),2)) + '%,' + str(round(np.mean(roc_RF_10_Last),2)) + '%,' + str(round(np.mean(roc_RF_15_Last),2)) + '%,' + str(round(np.mean(roc_RF_20_Last),2)) + '%\n')
            #
            # Recall.write(
            #     str(window) + ',' + str(ntp) + ',' + str(smote) + ',' + str(round(np.mean(roc_NB), 2)) + '%,' + str(
            #         round(np.mean(recall_NB_K), 2)) + '%,' + str(round(np.mean(recall_SVM_1), 2)) + '%,' + str(
            #         round(np.mean(recall_SVM_2), 2)) + '%,' + str(round(np.mean(recall_SVM_3), 2)) + '%,' + str(
            #         round(np.mean(recall_RF_5), 2)) + '%,' + str(round(np.mean(recall_RF_10), 2)) + '%,' + str(
            #         round(np.mean(recall_RF_15), 2)) + '%,' + str(round(np.mean(recall_RF_20), 2)) + '%\n')
            # Recall.write(str(window) + ',' + str(ntp) + '_Last' + ',' + str(smote) + ',' + str(
            #     round(np.mean(recall_NB_Last), 2)) + '%,' + str(round(np.mean(recall_NB_K_Last), 2)) + '%,' + str(
            #     round(np.mean(recall_SVM_1_Last), 2)) + '%,' + str(round(np.mean(recall_SVM_2_Last), 2)) + '%,' + str(
            #     round(np.mean(recall_SVM_3_Last), 2)) + '%,' + str(round(np.mean(recall_RF_5_Last), 2)) + '%,' + str(
            #     round(np.mean(recall_RF_10_Last), 2)) + '%,' + str(round(np.mean(recall_RF_15_Last), 2)) + '%,' + str(
            #     round(np.mean(recall_RF_20_Last), 2)) + '%\n')

            Precision.write(
                str(window) + ',' + str(ntp) + ',' + str(smote) + ',' + str(round(np.mean(precision_NB), 2)) + '%,' + str(
                    round(np.mean(precision_NB_K), 2)) + '%,' + str(round(np.mean(precision_SVM_1), 2)) + '%,' + str(
                    round(np.mean(precision_SVM_2), 2)) + '%,' + str(round(np.mean(precision_SVM_3), 2)) + '%,' + str(
                    round(np.mean(precision_RF_5), 2)) + '%,' + str(round(np.mean(precision_RF_10), 2)) + '%,' + str(
                    round(np.mean(precision_RF_15), 2)) + '%,' + str(round(np.mean(precision_RF_20), 2)) + '%\n')
            Precision.write(str(window) + ',' + str(ntp) + '_Last' + ',' + str(smote) + ',' + str(
                round(np.mean(precision_NB_Last), 2)) + '%,' + str(round(np.mean(precision_NB_K_Last), 2)) + '%,' + str(
                round(np.mean(precision_SVM_1_Last), 2)) + '%,' + str(round(np.mean(precision_SVM_2_Last), 2)) + '%,' + str(
                round(np.mean(precision_SVM_3_Last), 2)) + '%,' + str(round(np.mean(precision_RF_5_Last), 2)) + '%,' + str(
                round(np.mean(precision_RF_10_Last), 2)) + '%,' + str(round(np.mean(precision_RF_15_Last), 2)) + '%,' + str(
                round(np.mean(precision_RF_20_Last), 2)) + '%\n')
