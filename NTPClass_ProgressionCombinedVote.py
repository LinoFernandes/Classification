...
Recall = open(directory + 'Recall_CombVote.txt', 'a')
Precision = open(directory + 'Precision_CombVote.txt', 'a')
Scores = open(directory + 'AUC_CombVote.txt', 'a')
                    ...
                    if classifier == 0:
                        for kernel in range(0,1):
                            if kernel == 0:
                                ...
                                NB_Slow = [i.predicted for i in aux]
                                ...
                                aux = evaluation.predictions
                                NB_Neutral = [i.predicted for i in aux]
                                ...
                                aux = evaluation.predictions
                                NB_Fast = [i.predicted for i in aux]
                        ...
                        for degree in range(3,4):
                            ...
                            aux = evaluation.predictions
                            SVM_Slow = [i.predicted for i in aux]

                            mapper.build_classifier(dataTrainNeutral)
                            evaluation = Evaluation(dataTrainNeutral)
                            evaluation.test_model(mapper, dataTestNeutral)
                            aux = evaluation.predictions
                            SVM_Neutral = [i.predicted for i in aux]

                            mapper.build_classifier(dataTrainFast)
                            evaluation = Evaluation(dataTrainFast)
                            evaluation.test_model(mapper, dataTestFast)
                            aux = evaluation.predictions
                            SVM_Fast = [i.predicted for i in aux]
                        ...
                        for numTrees in np.arange(20,25,5):
                            ...
                            aux = evaluation.predictions
                            RF_Slow = [i.predicted for i in aux]

                            mapper.build_classifier(dataTrainNeutral)
                            evaluation = Evaluation(dataTrainNeutral)
                            evaluation.test_model(mapper, dataTestNeutral)
                            aux = evaluation.predictions
                            RF_Neutral = [i.predicted for i in aux]

                            mapper.build_classifier(dataTrainFast)
                            evaluation = Evaluation(dataTrainFast)
                            evaluation.test_model(mapper, dataTestFast)
                            aux = evaluation.predictions
                            RF_Fast = [i.predicted for i in aux]
        NB_Pred = []
        SVM_Pred = []
        RF_Pred = []
