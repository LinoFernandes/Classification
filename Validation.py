        ...
        for smote in [0]: #, 50, 100, 150, 200]:
            ...
            for fold in range(1, 11):
                ...
                if sys.platform == "darwin":
                    path = '/Users/Lino/PycharmProjects/Preprocessing/SnapProg/FOLDS_Prog/' + str(window) + 'd_FOLDS/Fast/S' +str(seed)
                ...
                for attribute in range(0,data.attributes().data.class_index):
                    ...
                    if (data.attribute_stats(attribute).missing_count/data.attributes().data.num_instances) > 0.5:
                ...
                #         sys.exit("Fold has full missing column")
                #     if (dataLast.attribute_stats(attribute).missing_count / dataLast.attributes().data.num_instances) > 0.5:
                #         toBeRemoved.append(str(attribute))
                ...
                saver.save_file(data, '/Users/Lino/PycharmProjects/Classification/Snapshots/ARFF_PROG/Fast/Data_'+ str(window) + 'd_S' + str(seed) + '_' + str(fold) + 'FOLD' + '.arff')
