...
directorySlow = '/Users/Lino/PycharmProjects/Preprocessing/NTP/New2/Slow/'
directoryNeutral = '/Users/Lino/PycharmProjects/Preprocessing/NTP/New2/Neutral/'
directoryFast = '/Users/Lino/PycharmProjects/Preprocessing/NTP/New2/Fast/'
...
for window in Window:
    for ntp in range(2,4):
        for dataset in ['Slow','Fast','Neutral']:
            if dataset == 'Slow':
                path = directorySlow + str(ntp) + 'TP/' + str(window) + 'd_' + str(ntp) + '.csv'
                testpath = directorySlow + str(ntp) + 'TP/' + str(window) + 'd_' + str(ntp) + '_Test.csv'
            elif dataset == 'Neutral':
                path = directoryNeutral + str(ntp) + 'TP/' + str(window) + 'd_' + str(ntp) + '.csv'
                testpath = directoryNeutral + str(ntp) + 'TP/' + str(window) + 'd_' + str(ntp) + '_Test.csv'
            else:
                path = directoryFast + str(ntp) + 'TP/' + str(window) + 'd_' + str(ntp) + '.csv'
                testpath = directoryFast+ str(ntp) + 'TP/' + str(window) + 'd_' + str(ntp) + '_Test.csv'
